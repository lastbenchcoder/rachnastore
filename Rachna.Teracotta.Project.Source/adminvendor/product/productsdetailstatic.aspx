<%@ Page Title="" Language="C#" MasterPageFile="~/adminvendor/Home.Master" AutoEventWireup="true" CodeBehind="productsdetailstatic.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.adminvendor.product.productsdetailstatic" %>
    ...
    <div class="container-fluid">
        <div class="page-header">
            ...
            <div class="pull-right" style="margin-top: 20px">
                ...
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <a href="/adminvendor/product/products.aspx?redirect-url=uyiretieyt7985798435ihtiuertireyte&id=alladmin.html" style="color: darkblue; font-weight: bolder; margin-right: 20px">All Products</a>
            </div>
        </div>
                ...
                <div class="box box-bordered">
                    <div class="box-title">
                        ...
                        <asp:Button ID="btnImageUpload" runat="server" Text="Upload Banner" class="btn btn-info" OnClick="btnImageUpload_Click" />
                            &nbsp &nbsp
                        <a href="/adminvendor/product/products.aspx?redirecturl=admin-allproduct-RachnaTeracotta" class="btn btn-brown">Go Back</a>
                            &nbsp &nbsp
                        </div>
                    </div>
