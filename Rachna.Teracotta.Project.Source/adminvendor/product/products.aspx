<%@ Page Title="" Language="C#" MasterPageFile="~/adminvendor/Home.Master" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.adminvendor.product.products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%
        ...
        _RequestList = context.Product.Include("SubCategory").Include("ProductBanner").Include("Admin").Include("Store").Where(m=>m.Store_Id ==_Administrator.Store_Id).ToList();
    ...
    <div class="container-fluid">
        <div class="page-header">
            ...
            <div class="pull-right">
                <a href="/adminvendor/product/newproducts.aspx?redirecturl=admin-Product-RachnaTeracotta" class="btn btn-primary" style="margin-top: 15px" data-toggle="modal">Add New</a>
            </div>
        </div>
                        ...
                        <table class="table table-hover table-nomargin table-bordered dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/adminvendor/product/uploadproductsbanner.aspx?Productid=<%=item.Product_Id %>"><%if (item.ProductBanner.Count > 0)
                                            { %>
                                    ...
                                    <%} %>
                                    <td><a href="/adminvendor/product/productsdetailstatic.aspx?Productid=<%=item.Product_Id %>"><i class="fa fa-edit fa-lg"></i></a></td>
                                    <%} %>
                            </tbody>
                        </table>
                    </div>
