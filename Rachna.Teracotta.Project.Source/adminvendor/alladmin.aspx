<%@ Page Title="" Language="C#" MasterPageFile="~/adminvendor/Home.Master" AutoEventWireup="true" CodeBehind="alladmin.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.adminvendor.alladmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%
        ...
        Administrators = Rachna.Teracotta.Project.Source.Core.bal.bAdministrator.List().Where(m=>m.Store_Id==_Administrator.Store_Id).ToList();
    %>
                        ...
                        <table class="table table-hover table-nomargin table-bordered dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/adminvendor/profile.aspx?adminid=<%=item.Administrators_Id %>&pageId=1234"><i class="fa fa-edit fa-lg"></i></a>
                                    </td>
                                </tr>
                                <%} %>
                            </tbody>
