...
namespace Rachna.Teracotta.Project.Source.adminvendor.salesmanagement
{
    public partial class vorderdetail : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("/adminvendor/salesmanagement/orders.aspx?id=j4242sdfsdfsdfs532543543fdsfsdfhgj657657HGH.htm");
        }

        protected void btnEdit_Click(object sender, EventArgs e)
        {
            Response.Redirect("/adminvendor/salesmanagement/orderdetail.aspx?orderId=" + hdnOrderId.Value + "&derdirect-url=12gdggd787hhgfhgfhgfhgfhg.htm");
        }
