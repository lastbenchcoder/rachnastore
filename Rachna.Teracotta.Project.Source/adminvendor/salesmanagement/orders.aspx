<%@ Page Title="" Language="C#" MasterPageFile="~/adminvendor/Home.Master" AutoEventWireup="true" CodeBehind="orders.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.adminvendor.salesmanagement.orders" %>
            ...
            <div class="container">
                <asp:GridView ID="grdStoreOrders" runat="server" AutoGenerateColumns="False" class="table table-striped grdStoreOrders">
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="Product_Id" DataNavigateUrlFormatString="/adminvendor/product/productsdetailstatic.aspx?Productid={0}&derdirect-url=12gdggd787hhgfhgfhgfhgfhg.htm" DataTextField="Product_Title" HeaderText="Product Title" />
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="Order_Id" DataNavigateUrlFormatString="/adminvendor/salesmanagement/vorderdetail.aspx?orderId={0}&derdirect-url=12gdggd787hhgfhgfhgfhgfhg.htm" Text="Detail" />
                    </Columns>
                    <EmptyDataTemplate>
