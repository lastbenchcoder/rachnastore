<%@ Page Title="" Language="C#" MasterPageFile="~/administration/Home.Master" AutoEventWireup="true" CodeBehind="productcommentsupdate.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.administration.product.productcommentsupdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%
        ...
        {
            Response.Redirect("/administration/product/productcomments.aspx?redirecturl=admin-productcomments-RachnaTeracotta");
        }
    %>
                    ...
                    <div class="box-content nopadding">
                        <div class='form-horizontal form-striped'>
                            ...
                            <div class="form-actions col-sm-offset-2 col-sm-10">
                                ...
                                <a href="/administration/product/productcomments.aspx?redirecturl=admin-productcomments-RachnaTeracotta">Go Back</a>
                            </div>
                        </div>
                    </div>
                </div>
