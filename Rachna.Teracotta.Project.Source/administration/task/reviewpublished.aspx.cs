...
{
    public partial class reviewpublished : System.Web.UI.Page
    {
                    ...
                    if (row.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (chkRow.Checked)
                        {
                            ...
                            using (var ctx = new RachnaDBContext())
                            {
                                ...
                                _Product.Product_Status = eProductStatus.Published.ToString();
        ...
        public void LoadDetail()
        {
            using (var ctx = new RachnaDBContext())
            {
                grdReviewPending.DataSource = ctx.Product.Where(m => m.Product_Status == eProductStatus.Approved.ToString()).ToList();
