<%@ Page Title="" Language="C#" MasterPageFile="~/administration/Home.Master" AutoEventWireup="true" CodeBehind="reviewapproved.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.administration.task.reviewapproved" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        <div style="margin-left: 10px; margin-top: 10px; margin-bottom: 10px">
            <h3>Items Pending for Approve</h3>
            <p>
                Please review the items and approve that, selected items will be set to approved status. Only pubished items will be displayed in Front End.
            </p>
        </div>
