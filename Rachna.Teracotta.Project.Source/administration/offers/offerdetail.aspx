<%@ Page Title="" Language="C#" MasterPageFile="~/administration/Home.Master" AutoEventWireup="true" CodeBehind="offerdetail.aspx.cs" ValidateRequest="false" Inherits="Rachna.Teracotta.Project.Source.administration.offers.offerdetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--CSS for Disable Past Due Date-->
    <link rel="stylesheet" href="~/content/admin/css/CSS.css">
    <!--JS For disable past dates -->
    <script src="../../content/admin/js/Extension.min.js"></script>
                ...
                <div class="box box-bordered">
                    ...
                    <div class="box-content nopadding">
                        <div class='form-horizontal form-striped'>
                            ...
                            <div class="form-group">
                                <label for="txtFirstName" class="control-label col-sm-2">Starts From :</label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtStartDate" runat="server" CssClass="disable_past_dates" />
                                    <asp:ImageButton runat="server" ID="imgPopup" ImageUrl="../../content/calender.png" Width="15" />
                            ...
                            <div class="form-group">
                                <label for="txtFirstName" class="control-label col-sm-2">Ends On :</label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtEndDate" runat="server" CssClass="disable_past_dates" />
                                    <asp:ImageButton runat="server" ID="imgPopUpEndDate" ImageUrl="../../content/calender.png" Width="15" />
                                    <cc1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtEndDate"
                                        PopupButtonID="imgPopUpEndDate" Format="dd/MM/yyyy" />
                                    ...
                                    <asp:CompareValidator ID="CompareValidatorT1" runat="server" ControlToValidate="txtStartDate"
                                        ControlToCompare="txtEndDate" Type="Date" ValidationGroup="admin" Operator="LessThanEqual"
                                        ErrorMessage="Invalid Date Range" ForeColor="Red"></asp:CompareValidator>
                                </div>
                            </div>
