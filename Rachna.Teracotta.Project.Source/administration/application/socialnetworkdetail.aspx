<%@ Page Title="" Language="C#" MasterPageFile="~/administration/Home.Master" AutoEventWireup="true" CodeBehind="socialnetworkdetail.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.administration.application.socialnetworkdetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="page-header">
            <div class="pull-left">
                <h1>Social Networking Detail</h1>
            </div>
        </div>
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="/administration/application/socialnetwork.aspx?redirectUrl=category-administrator-home&pageId=1234HJHJKJ*7987979">Social Networking</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <a href="#">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="fa fa-th-list"></i>Update Social Networking Detail</h3>
                        <asp:HiddenField ID="hdnSocialNetworkingId" runat="server" />
                    </div>
