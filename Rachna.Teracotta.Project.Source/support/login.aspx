<%@ Page Title="" Language="C#" MasterPageFile="~/support/Account.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Rachna.Teracotta.Project.Source.support.login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="forget">
        <a href="/account/forgotpassword.aspx?redirectUrl=forget-administrator-home&pageId=1234HJHJKJ*7987979" target="_blank">
